      ...
      <div className="row">
        <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6">
          <div className="d-flex flex-column justify-content-center">
            ...
            Get high-quality intuitive user interface templates for personal and business needs, download and customize what do you want.
            </div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-5">
          <div className="row justify-content-end mt-2 pt-5">
            <div className="frame-hero-image position-relative">
              <img src={bgHero} alt="hero-background" className="hero-image position-absolute" />
            </div>
            ...
            <div className="col-sm-12 col-md-6 col-lg-6 col-xl-6" style={{ zIndex: 22 }} >
